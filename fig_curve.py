...
fig2.legend(('Model length', 'Data length', 'Total message length'),
           'upper center', shadow=True, fancybox=True)


#leg = fig2.gca().get_legend()
...
fig2.setp(ltext, fontsize='small')    # the legend text fontsize
fig2.setp(llines, linewidth=1.5)      # the legend linewidth
